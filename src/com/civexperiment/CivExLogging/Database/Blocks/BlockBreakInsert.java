...
public class BlockBreakInsert implements Insertable
{
    ...
    Long time;
    String world, action, player, content, reinfHealth, item_main, item_off, block_Material;
    ...
    public String getStatement()
    {
        return "INSERT INTO `tbl_block_log` (`col_timestamp`, `col_world`,`col_action`,`col_player`,`col_item_held_right`," +
                ...
                "`col_block_type`,`col_block_x`,`col_block_y`,`col_block_z`,`col_content`,`col_reinforcement_health`) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    }
}
