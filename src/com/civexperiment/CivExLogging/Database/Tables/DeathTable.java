...
public class DeathTable implements Table
{
    ...
    {
        return "CREATE TABLE `tbl_death_log` (" +
                "  `col_id` int(11) NOT NULL AUTO_INCREMENT," +
                "  `col_server` varchar(100) DEFAULT NULL," +
                ...
                "  `col_victim_item` int(11) DEFAULT NULL," +
                ...
                "  `col_killer_item` int(11) DEFAULT NULL," +
